# Generated by Django 3.2.7 on 2022-04-17 14:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hood', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posting', to='hood.neighbourhood')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='developer', to='hood.profile')),
            ],
        ),
        migrations.AddField(
